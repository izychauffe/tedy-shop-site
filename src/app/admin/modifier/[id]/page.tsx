...
import { Categorie, Produit } from "@/lib/produits";
  ...
  useEffect(() => {
    const chargerProduit = async () => {
      ...
      if (!error && data) {
        ...
        setTailles(produit.tailles.join(", "));
        setCouleurs(produit.couleurs.join(", "));
        setImageActuelle(produit.image_url);
      }
      setChargement(false);
    };
    chargerProduit();
    ...
    <div className="min-h-screen px-6 md:px-12 py-12 max-w-xl mx-auto">
      ...
      <form onSubmit={handleEnregistrer} className="flex flex-col gap-5">
        ...
        <div>
          ...
          {(apercu || imageActuelle) && (
            // eslint-disable-next-line @next/next/no-img-element
            <img
              src={apercu || imageActuelle || ""}
              alt="Aperçu"
